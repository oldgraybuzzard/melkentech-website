...
export const timelineItems: TimelineItem[] = [
  {
    ...
    description: "Established as Melken Solutions, focusing on technical documentation, software solutions, and supporting government contracts."
  },
  {
    id: "2",
    year: "2012",
    title: "Accepted into the UCF Small Business Incubation Program",
    description: "Became part of the University of Central Florida's business incubator, gaining access to mentorship, resources, and growth opportunities."
  },
  {
    id: "3",
    year: "2015",
    title: "Graduated from UCF Small Business Incubation Program",
    description: "Successfully completed the program, positioning Melken Solutions for greater business expansion and innovation."
  },
  {
    id: "4",
    year: "2017",
    title: "GSA Schedule Award",
    description: "Awarded GSA Multiple Award Schedule, expanding our reach and capabilities in federal contracting."
  },
  {
    id: "5",
    year: "2018",
    title: "Onsite Project Manager - US Navy LCS MBT Relocation",
    description: "Managed the relocation effort of the LCS Mission Bay Trainer from San Diego to Mayport, FL as a subcontractor to Cubic Defense."
  },
  {
    id: "6",
    year: "2019",
    title: "Onsite Project Manager - LCS MBT System Installation at LTF Mayport",
    description: "Oversaw the installation of the LCS Mission Bay Trainer system at the Littoral Training Facility in Mayport from 2019 to 2021."
  },
  {
    id: "7",
    year: "2020",
    title: "LCS MBT",
    description: "Providing logistics support services, system integration, installation, and documentation for the LCS MBT program."
  },
  {
    id: "8",
    year: "2021",
